...
// Auto-generated page for: Community engagement + retention scoring with event and comm

export default function CfCommunityEngagementRetentionScoringW() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-community-engagement-retention-scoring-w', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Community engagement + retention scoring with event and comm</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Community engagement + retention scoring with event and communication-cadence recommendations.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Community engagement + retention scoring with event and comm'}
        </button>
      </form>
