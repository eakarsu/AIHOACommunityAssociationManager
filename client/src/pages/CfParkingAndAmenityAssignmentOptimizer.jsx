...
// Auto-generated page for: Parking and amenity assignment optimizer accounting for pref

export default function CfParkingAndAmenityAssignmentOptimizer() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-parking-and-amenity-assignment-optimizer', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Parking and amenity assignment optimizer accounting for pref</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Parking and amenity assignment optimizer accounting for preferences and accessibility.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Parking and amenity assignment optimizer accounting for pref'}
        </button>
      </form>
