...
// Auto-generated page for: No property assessment fairness audit

export default function GapNoPropertyAssessmentFairnessAudit() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-property-assessment-fairness-audit', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No property assessment fairness audit</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No property assessment fairness audit</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No property assessment fairness audit'}
        </button>
      </form>
