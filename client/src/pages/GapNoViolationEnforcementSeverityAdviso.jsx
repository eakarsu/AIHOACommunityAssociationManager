...
// Auto-generated page for: No violation-enforcement severity advisor

export default function GapNoViolationEnforcementSeverityAdviso() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-violation-enforcement-severity-adviso', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No violation-enforcement severity advisor</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No violation-enforcement severity advisor</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No violation-enforcement severity advisor'}
        </button>
      </form>
