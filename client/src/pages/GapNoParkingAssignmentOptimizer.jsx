...
// Auto-generated page for: No parking assignment optimizer

export default function GapNoParkingAssignmentOptimizer() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-parking-assignment-optimizer', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No parking assignment optimizer</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No parking assignment optimizer</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No parking assignment optimizer'}
        </button>
      </form>
