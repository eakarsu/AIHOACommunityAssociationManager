...
// Auto-generated page for: Reserve study + long-term capital planner with 10-20 year ho

export default function CfReserveStudyLongTermCapitalPlanner() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-reserve-study-long-term-capital-planner', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Reserve study + long-term capital planner with 10-20 year ho</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Reserve study + long-term capital planner with 10-20 year horizons.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Reserve study + long-term capital planner with 10-20 year ho'}
        </button>
      </form>
