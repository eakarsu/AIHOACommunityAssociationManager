...
// Auto-generated page for: No reserve-study projector for capital planning

export default function GapNoReserveStudyProjectorForCapital() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-reserve-study-projector-for-capital', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No reserve-study projector for capital planning</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No reserve-study projector for capital planning</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No reserve-study projector for capital planning'}
        </button>
      </form>
