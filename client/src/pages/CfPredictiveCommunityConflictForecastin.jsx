...
// Auto-generated page for: Predictive community conflict forecasting from complaint and

export default function CfPredictiveCommunityConflictForecastin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-predictive-community-conflict-forecastin', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Predictive community conflict forecasting from complaint and</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Predictive community conflict forecasting from complaint and maintenance trends.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Predictive community conflict forecasting from complaint and'}
        </button>
      </form>
